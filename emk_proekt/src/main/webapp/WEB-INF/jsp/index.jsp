...
<link rel="stylesheet"
	href="bower_components/angular-motion/dist/angular-motion.css" />
<link rel="stylesheet"
	href="bower_components/fullcalendar/dist/fullcalendar.css" />
<link rel="stylesheet" href="bower_components/select2/select2.css" />
<link rel="stylesheet"
	href="bower_components/bootstrap-markdown/css/bootstrap-markdown.min.css" />
<link rel="stylesheet"
	href="bower_components/datetimepicker/jquery.datetimepicker.css" />
<link rel="stylesheet" href="bower_components/ng-table/ng-table.css" />
<link rel="stylesheet"
	href="bower_components/ngQuickDate/dist/ng-quick-date.css" />
<link rel="stylesheet"
	href="bower_components/ngQuickDate/dist/ng-quick-date-default-theme.css" />
<!-- endbower -->
<!-- endbuild -->
...
<![endif]-->
	...
	<div class="page-container">
		<header ng-include="'nav/top.html'"></header>
...
<![endif]-->
	...
	<script
		src="bower_components/bootstrap-markdown/js/bootstrap-markdown.js"></script>
	<script src="bower_components/datetimepicker/jquery.datetimepicker.js"></script>
	<script
		src="bower_components/jquery-textcomplete/dist/jquery.textcomplete.min.js"></script>
	...
	<script src="scripts/controllers/mainAdvert.js"></script>
	<script src="scripts/controllers/user.js"></script>
	<script src="scripts/controllers/advert-description.js"></script>
  <script src="scripts/controllers/advert-apply.js"></script>

  <script src="scripts/controllers/browse-city.js"></script>
  ...
  <script src="scripts/services/favorite.js"></script>

  <script src="scripts/services/mainAdvert.js"></script>
  <script src="scripts/services/advertApply.js"></script>

	<script src="scripts/directives/combo.js"></script>
	<script src="scripts/directives/book-display.js"></script>
	<script src="scripts/directives/advert-display.js"></script>
  <script src="scripts/directives/example-display.js"></script>
  <script src="scripts/directives/order_payment.js"></script>
  <script src="scripts/directives/paypal-button.js"></script>
  <script src="scripts/directives/favorite-display.js"></script>
